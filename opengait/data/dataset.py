...
class DataSet(tordata.Dataset):
    ...
    def __dataset_parser(self, data_config, training):
        ...
        train_set = partition["TRAIN_SET"] # number = 74
        test_set = partition["TEST_SET"]    # number = 50
        label_list = os.listdir(dataset_root) # number = 124
        train_set = [label for label in train_set if label in label_list] #number = 74
        test_set = [label for label in test_set if label in label_list] # number = 50
